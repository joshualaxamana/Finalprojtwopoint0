<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Register.aspx.cs" Inherits="Guard_Register" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Security Guard Registration Form</title>
            ...
            <div class="well">
                <form runat="server" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <asp:TextBox ID="txtID" runat="server" CssClass="form-control" text=""
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-4 col-lg-8">
                            <asp:Button ID="btnRegister" runat="server"
                                CssClass="btn btn-lg btn-success" Text="Register" onclick="btnRegister_Click"/>
