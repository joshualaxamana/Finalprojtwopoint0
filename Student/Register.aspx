<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Register.aspx.cs" Inherits="Student_Register" %>
                ...
                <form runat="server" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-4 col-lg-8">
                            <asp:Button ID="btnRegister" runat="server" CssClass="btn btn-lg btn-success" Text="Register" onclick="btnRegister_Click"/>
